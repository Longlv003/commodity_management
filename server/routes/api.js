...
router.get(
  "/banner/sale/list/admin",
  mdw.api_auth,
  mdw.checkRole(["admin", "engineer"]),
  bannerCtrl.GetAllBannersAdmin
);
router.put(
  "/banner/sale/update/:_id",
  mdw.api_auth,
  mdw.checkRole(["admin", "engineer"]),
  upload.single("image"),
...
router.get("/category/list/all", catCtrl.getAllCategories);
...
router.put(
  ...
  mdw.checkRole(["admin", "engineer"]),
  upload.single("image"),
  pVariantCtrl.EditVariant
);
router.delete(
  "/variant/delete/:_id",
  mdw.api_auth,
  mdw.checkRole(["admin", "engineer"]),
  pVariantCtrl.DeleteVariant
);

// User Favorite
router.post("/favorite/toggle", mdw.api_auth, userFavoriteCtrl.ToggleFavorite);
router.get(
  "/favorite/check/:product_id",
  mdw.api_auth,
  userFavoriteCtrl.CheckFavorite
);
...
router.get(
  ...
  mdw.api_auth,
  mdw.checkRole(["admin", "engineer"]),
  statisticsCtrl.GetRevenueStatistics
);
router.get(
  "/statistics/top-selling",
  mdw.api_auth,
  mdw.checkRole(["admin", "engineer"]),
  statisticsCtrl.GetTopSellingProductsStats
);
...
router.get(
  ...
  mdw.api_auth,
  mdw.checkRole(["admin", "engineer"]),
  customerCtrl.GetCustomerDetail
);
router.post(
  "/customer/add",
  mdw.api_auth,
